...
function ProjectPage() {
    ...
    const [state] = useState([
        {
            ...
            tags: ['ReactJS', 'Redux', 'CSS3', 'REST','HTML5', 'Realtime', 'Firebase'],
            desc: [
    ...
    return (
        ...
        <div className={classes.Projects}>
           <Projects paginateData={paginateData} setPaginateData={setPaginateData} submitted={submitted} setSubmitted={setSubmitted} state={state} text={text} setText={setText}/>
        </div>
    )
}
